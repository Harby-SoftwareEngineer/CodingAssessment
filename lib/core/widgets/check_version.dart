...
class AppVersionChecker {
  ...
  void checkVersion(BuildContext context, {bool isWillPop = true}) async {
  ...
  verifyVersion(BuildContext context, {bool isWillPop = true}) async {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        PrimaryButton(
                          ...
                          backgroundColor: const Color(0xffF67D31),
                          onPressed: () async {
