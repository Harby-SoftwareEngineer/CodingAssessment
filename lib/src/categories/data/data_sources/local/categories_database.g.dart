...
class _$CategoriesDatabase extends CategoriesDatabase {
  ...
  CategoriesDao? _cartQueryDaoInstance;
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `CategoryDto` (`id` INTEGER, `name` TEXT, `image` TEXT, `creationAt` TEXT, `updatedAt` TEXT, PRIMARY KEY (`id`))');
  ...
  CategoriesDao get cartQueryDao {
    return _cartQueryDaoInstance ??= _$CategoriesDao(database, changeListener);
  }
}
...
class _$CategoriesDao extends CategoriesDao {
  ...
  @override
  Future<List<CategoryDto>> fetchCartQuery() async {
    return _queryAdapter.queryList('SELECT * FROM CategoriesDao',
  ...
  @override
  Future<void> insertProduct(List<CategoryDto> params) async {
