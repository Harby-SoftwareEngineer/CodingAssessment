...
class _ProfileDataSource implements ProfileDataSource {
  ...
  Future<ApiResponse<ProfileDto>> fetchProfileData() async {
    ...
    final _options = _setStreamType<ApiResponse<ProfileDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ApiResponse<CommunicationDto>> fetchCommunicationData() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<CommunicationDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<CommunicationDto> _value;
    try {
      _value = ApiResponse<CommunicationDto>.fromJson(
        _result.data!,
